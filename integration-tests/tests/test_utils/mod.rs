...
pub fn proof(
    ...
    let query_response: Result<solana_multisig_prover::msg::ProofResponse, StdError> = multisig_prover
        .query(
            app,
...
pub fn verifier_set_from_prover(
    ...
    let query_response: Result<Option<VerifierSetResponse>, StdError> =
        multisig_prover_contract.query(app, &solana_multisig_prover::msg::QueryMsg::CurrentVerifierSet);
    assert!(query_response.is_ok());
