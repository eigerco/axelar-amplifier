...
#[derive(Clone, Debug, PartialEq, serde::Serialize, serde::Deserialize)]
pub enum AuthWeightedEvent {
    SignersRotated(SignersRotated),
}
impl cainome::cairo_serde::CairoSerde for AuthWeightedEvent {
    type RustType = Self;
    const SERIALIZED_SIZE: std::option::Option<usize> = std::option::Option::None;
    #[inline]
    fn cairo_serialized_size(__rust: &Self::RustType) -> usize {
        match __rust {
            AuthWeightedEvent::SignersRotated(val) => {
                SignersRotated::cairo_serialized_size(val) + 1
            }
            _ => 0,
        }
    }
    ...
    fn cairo_deserialize(
        ...
        match __index as usize {
            0usize => {
                Ok(
                    AuthWeightedEvent::SignersRotated(
            ...
            _ => {
                return Err(
                    cainome::cairo_serde::Error::Deserialize(
                        format!("Index not handle for enum {}", "AuthWeightedEvent"),
                    ),
                );
            }
        }
...
impl TryFrom<&starknet_core::types::EmittedEvent> for AuthWeightedEvent {
    type Error = String;
    fn try_from(
                ...
                .unwrap_or_else(|_| panic!("Invalid selector for {}", "SignersRotated"))
        {
            ...
            return Ok(
                AuthWeightedEvent::SignersRotated(SignersRotated {
                    epoch,
                    signers_hash,
                    signers,
                }),
...
impl TryFrom<&starknet_core::types::Event> for AuthWeightedEvent {
    type Error = String;
...
pub enum Event {
    ...
    AuthWeighted(AuthWeightedEvent),
    OwnableEvent(OwnableEvent),
    UpgradeableEvent(UpgradableEvent),
}
impl cainome::cairo_serde::CairoSerde for Event {
    ...
    fn cairo_serialized_size(__rust: &Self::RustType) -> usize {
        match __rust {
            ...
            Event::AuthWeighted(val) => AuthWeightedEvent::cairo_serialized_size(val) + 1,
            Event::OwnableEvent(val) => OwnableEvent::cairo_serialized_size(val) + 1,
            Event::UpgradeableEvent(val) => {
                UpgradableEvent::cairo_serialized_size(val) + 1
            }
            _ => 0,
        }
    }
    fn cairo_serialize(__rust: &Self::RustType) -> Vec<starknet_core::types::Felt> {
        match __rust {
            ...
            Event::AuthWeighted(val) => {
                ...
                temp.extend(AuthWeightedEvent::cairo_serialize(val));
                temp
            }
            ...
            Event::UpgradeableEvent(val) => {
                ...
                temp.extend(UpgradableEvent::cairo_serialize(val));
                temp
            }
            _ => vec![],
        }
    ...
    fn cairo_deserialize(
        ...
        match __index as usize {
            ...
            5usize => {
                Ok(
                    Event::AuthWeighted(
                        AuthWeightedEvent::cairo_deserialize(__felts, __offset + 1)?,
                    ),
                )
            }
            6usize => {
            ...
            7usize => {
                Ok(
                    Event::UpgradeableEvent(
                        UpgradableEvent::cairo_deserialize(__felts, __offset + 1)?,
                    ),
                )
            }
            _ => {
...
impl TryFrom<&starknet_core::types::EmittedEvent> for Event {
    ...
    fn try_from(
                ...
                .unwrap_or_else(|_| panic!("Invalid selector for {}", "Upgraded"))
        {
            ...
            return Ok(
                Event::UpgradeableEvent(
                    UpgradableEvent::Upgraded(Upgraded { class_hash }),
                ),
            );
        }
        Err(format!("Could not match any event from keys {:?}", event.keys))
...
impl cainome::cairo_serde::CairoSerde for OwnableEvent {
    ...
    fn cairo_deserialize(
        ...
        match __index as usize {
            ...
            1usize => {
                Ok(
                    OwnableEvent::OwnershipTransferStarted(
            ...
            _ => {
                return Err(
                    cainome::cairo_serde::Error::Deserialize(
                        format!("Index not handle for enum {}", "OwnableEvent"),
                    ),
                );
            }
        }
...
impl TryFrom<&starknet_core::types::EmittedEvent> for OwnableEvent {
    type Error = String;
    fn try_from(
        event: &starknet_core::types::EmittedEvent,
    ) -> Result<Self, Self::Error> {
...
impl TryFrom<&starknet_core::types::Event> for OwnableEvent {
    type Error = String;
    fn try_from(event: &starknet_core::types::Event) -> Result<Self, Self::Error> {
        use cainome::cairo_serde::CairoSerde;
        if event.keys.is_empty() {
...
#[derive(Clone, Debug, PartialEq, serde::Serialize, serde::Deserialize)]
pub enum UpgradableEvent {
    Upgraded(Upgraded),
}
impl cainome::cairo_serde::CairoSerde for UpgradableEvent {
    type RustType = Self;
    const SERIALIZED_SIZE: std::option::Option<usize> = std::option::Option::None;
    #[inline]
    fn cairo_serialized_size(__rust: &Self::RustType) -> usize {
        match __rust {
            UpgradableEvent::Upgraded(val) => Upgraded::cairo_serialized_size(val) + 1,
            _ => 0,
        }
    }
    fn cairo_serialize(__rust: &Self::RustType) -> Vec<starknet_core::types::Felt> {
        match __rust {
            UpgradableEvent::Upgraded(val) => {
                let mut temp = vec![];
                temp.extend(usize::cairo_serialize(&0usize));
    ...
    fn cairo_deserialize(
        ...
        match __index as usize {
            ...
            _ => {
                return Err(
                    cainome::cairo_serde::Error::Deserialize(
                        format!("Index not handle for enum {}", "UpgradableEvent"),
                    ),
                );
            }
        }
...
impl TryFrom<&starknet_core::types::EmittedEvent> for UpgradableEvent {
    type Error = String;
    fn try_from(
        event: &starknet_core::types::EmittedEvent,
    ) -> Result<Self, Self::Error> {
                ...
                .unwrap_or_else(|_| panic!("Invalid selector for {}", "Upgraded"))
        {
            ...
            data_offset
                += cainome::cairo_serde::ClassHash::cairo_serialized_size(&class_hash);
            return Ok(UpgradableEvent::Upgraded(Upgraded { class_hash }));
        }
        Err(format!("Could not match any event from keys {:?}", event.keys))
    }
}
impl TryFrom<&starknet_core::types::Event> for UpgradableEvent {
    type Error = String;
    fn try_from(event: &starknet_core::types::Event) -> Result<Self, Self::Error> {
        use cainome::cairo_serde::CairoSerde;
        if event.keys.is_empty() {
